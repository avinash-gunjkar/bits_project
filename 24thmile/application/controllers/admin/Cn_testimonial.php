...
class Cn_testimonial extends CI_Controller {

	public $session_user;
	public $viewFilePath ="backend/testimonial/";
	public $redirectPath = "admin/testimonial";
	...
	public function ajaxTestimonial()
	{	
	...
	{	
        ...
        $data['page_title'] = $details?"Edit Testimonial":"Add Testmonial";
