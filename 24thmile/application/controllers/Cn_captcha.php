...
class Cn_captcha extends CI_Controller {
...
$fonts = [dirname(__FILE__).'/../../assets/frontend/captcha-fonts/Acme-Regular.ttf'];
...
public function validateCaptchaText(){
    //for jquery remote validation
    if(strcmp($this->input->get('captcha_challenge'), $this->session->userdata('captcha_text'))==0){
        echo 'true';
        die;
    }
    echo 'false';
