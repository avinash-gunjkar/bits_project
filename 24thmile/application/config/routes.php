...
$route['fs-edit-document-master-form'] = 'seller_dms/edit_document_master_form';
$route['fs-delete-document-master-form'] = 'seller_dms/delete_document_master_form';

//fs-dms/rfc_id/
$route['fs-dms'] = 'seller_dms/index';
