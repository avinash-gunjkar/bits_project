                    ...
                    <div class="tab-content">
                        ...
                        <div>
                                <?php if($reportType=='Import'){
                                    $this->load->view('frontend/seller/reports_import_template', ['shippig_requirment_list'=>$shippig_requirment_list]);
                                }else{
                                    $this->load->view('frontend/seller/reports_export_template', ['shippig_requirment_list'=>$shippig_requirment_list]);
                                }?>
                        </div>
                    </div>
                </div>
