                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="text" name="other_details[reference]" class="form-control requiredClass" placeholder="Add reference..." value="<?= $other_details->reference ?>">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <?php if (!empty($items)) { ?>
                                        <?php foreach ($items as $key => $item) { ?>
                                            <tr>
                                                ...
                                                <td><input type="text" maxlength="100" style="text-align :left" class="form-control" name="items[<?= $key ?>][document_number_date]" placeholder="Number and Date of Document.." value="<?= $item->document_number_date ?>"></td>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td><input type="text" maxlength="100" style="text-align :left" class="form-control" name="items[{uid}][document_number_date]" placeholder="Number and Date of Document..."></td>
