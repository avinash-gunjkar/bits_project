                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <div><label for="" style="min-width: 100px;">Export Invoice Number</label>
                                            <div class="editable">
                                    ...
                                    <td>
                                        <div><label for="" style="min-width: 100px;" >Letter of Credit Number</label>
                                ...
                                <tr>
                                    ...
                                    <input class="date-picker form-control" type="text" name="other_details[date_of_departure]" value="<?= printFormatedDate($other_details->date_of_departure) ?>">
                                ...
                                <tr>                
                                    ...
                                    <td colspan="2"><label for="" style="min-width: 100px;" >Declaration By The Exporter:</label>
                                        <div class="editable-textarea">
                                            <textarea name="other_details[declaration_by_exporter]" class="form-control wysihtml5-editor-no-controlls" rows="2"><?=$other_details->declaration_by_exporter?></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
