                    ...
                    <div class="tracking-block">
                        <div class="tab-content">
                            ...
                            <form id="documentForm" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div style="padding: 1px 0px;">Date :- <b> <?= printFormatedDate($other_details->document_date) ?></b></div><br>

                                <div style="padding: 2px 0px;">The Branch Manager,</div>
                                <div style="padding: 2px 0px;" ><?= $other_details->name_of_bank ?></div>
                                <div style="padding: 2px 0px;"><?= $other_details->branch_name ?></div>
                                <div><?= $other_details->branch_place ?></div>

                                <div style="padding: 20px 0px;">
                                Subject:- <b><?= $other_details->subject ?></b>
                                </div>
                                <div style="padding: 10px 0px">Dear <b> Madam/Sir,</b></div>
                                ...
                                <div> <b> A) Details of Self attested Bill of Entries enclosed. </b></div>
