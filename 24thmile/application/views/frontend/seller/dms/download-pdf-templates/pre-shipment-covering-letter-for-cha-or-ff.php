                ...
                <div class="col-12 col-lg-12">
                    <div class="tracking-block">
                        <div class="tab-content">
                            ...
                            <div>
                                <label style="font-weight: normal;">Date:</label> <span><?= printFormatedDate($other_details->date) ?></span>
                            </div>
                            <br>
                            <div>
                                <label style="font-weight: normal;">Kind attention:</label><span><?= $other_details->person ?></span>
                            </div>
                            ...
                            <div>
                                ...
                                <span><?= $other_details->address1 ?></span>
                            </div>


                            <div>
                                <!-- <label for="">Address2 :</label> -->
                                <span><?= $other_details->address2 ?></span>
                            </div>
                            <br>
                            ...
                            <br>
                            <div style="margin: 10px 5px 0px 0">
                                <span>Dear </span>
