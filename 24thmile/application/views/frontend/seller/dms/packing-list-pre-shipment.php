                        ...
                        <form id="documentForm" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    <tr>
                                        <td rowspan="3" colspan="2">
                                            ...
                                            <div class="editable-textarea">
                                                <textarea name="other_details[exporter]" id="exporter" class="form-control requiredClass wysihtml5-editor-no-controlls" rows="10"><?= $other_details->exporter ?></textarea>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div><label style="min-width: 142px;">Invoice Number</label>
                                                <div class="editable">
                                                    <input type="text" id="custom_invoice_number" class="form-control requiredClass" name="other_details[invoice_number]" value="<?= htmlspecialchars($other_details->invoice_number) ?>">
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <div><label style="min-width: 135px;">Authorized Dealer Code</label>
                                                <div class="editable"><input type="text" name="other_details[ad_code]" onkeyup="addHyphen(this)" class="form-control requiredClass" value="<?= formated_ad_code(htmlspecialchars($other_details->ad_code)) ?>"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="editable-textarea">
                                                <textarea name="other_details[notify_party]" id="notify_party" class="form-control wysihtml5-editor-no-controlls" rows="6"><?= $other_details->notify_party ?></textarea>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="editable-textarea">
                                                <textarea name="other_details[consignee]" id="consignee" class="form-control requiredClass wysihtml5-editor-no-controlls" rows="5"><?= $other_details->consignee ?></textarea>
                                            </div>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="editable-textarea">
                                                <textarea name="other_details[buyer]" id="buyer" class="form-control requiredClass wysihtml5-editor-no-controlls" rows="5"><?= $other_details->buyer ?></textarea>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <!-- <input type="text" name="other_details[pre_carriage_by]" class="form-control requiredClass" value="<?= $other_details->pre_carriage_by ?>"> -->
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2" colspan="2"><label>Terms / Method of Payment</label>
                                            <div class="editable-textarea">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-left" colspan='4'><label> Any Special Consideration for Shipment: </label>
                                            <div class="editable-textarea">
                                                <textarea cols="200" rows="4" class="form-control requiredClass wysihtml5-editor-no-controlls" name="other_details[special_consideration]"><?= $other_details->special_consideration ?></textarea>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <p>Export Shipment under LUT No: <span><?= htmlspecialchars($other_details->lut_no) ?></span> &nbsp;&nbsp;&nbsp; LUT Valid till <input type="text" value="<?= htmlspecialchars($other_details->export_under_lut_no_valid_date) ?>" class="date-picker form-control" style="width:200px;display:inline" name="other_details[export_under_lut_no_valid_date]" maxlength="15">&nbsp;&nbsp;&nbsp; GST No.: <span><?= htmlspecialchars($other_details->gst_no) ?></span> </p>
                                            <input type="hidden" class="form-control" style="width:200px;display:inline" value="<?= htmlspecialchars($other_details->lut_no) ?>" name="other_details[lut_no]" maxlength="40">
                                            <input type="hidden" value="<?= htmlspecialchars($other_details->gst_no) ?>" class="form-control" style="width:200px;display:inline" name="other_details[gst_no]" maxlength="40">
                                            <br>
