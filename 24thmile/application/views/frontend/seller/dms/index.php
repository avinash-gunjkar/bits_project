                                ...
                                <div class="shipping-form-block">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="tableServerside" class="mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $counter = 0;
                                                foreach ($documetTypeList['pre-shipment'] as $key => $documentType) { ?>
                                                    <?php $documentPermission = checkDocumentPermission($documentType->document, $masterFormDetails->transaction, $masterFormDetails->mode, $masterFormDetails->shipment, 'EXIM');
                                                    if ($documentPermission) { ?>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <td>
                                                                <?php if (in_array($documentType->status,['0','1']) && $documentPermission == 'edit') { ?>
                                                                    <a class="btn btn-sm btn-primary" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document") ?>">Edit</a>
                                                                    <form action="<?= base_url("fs-dms/deleteDocument/$masterFormDetails->id/$documentType->document") ?>" method="post" style="display: inline">
                                                                        <input type="hidden" name="master_form_id" value="<?= $masterFormDetails->id ?>" />
                                                                    ...
                                                                    <a class="btn btn-sm btn-warning" target="_blank" href="<?= base_url("fs-dms/download/$masterFormDetails->id/$documentType->document") ?>">Download</a>
                                                                    <?php if ($documentType->document == 'packing-list-pre-shipment') { ?>
                                                                    <a class="btn btn-sm btn-success" target="_blank" href="<?= base_url("fs-dms/download/$masterFormDetails->id/shiping-marks-pre-shipment") ?>">Shipping Marks</a>
                                                                    <?php } ?>
                                                                <?php } else if ($documentPermission == 'edit') { ?>
                                                                    <?php if ($documentType->document == 'custom-invoice') { ?>
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                <a class="dropdown-item" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document?type=commercial-shipment") ?>">Commercial Shipment</a>
                                                                                <a class="dropdown-item" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document?type=sample-shipment") ?>">Sample Shipment</a>
                                                                                <!-- <a class="dropdown-item" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document?type=proforma-invoice") ?>">Proforma Invoice</a> -->
                                                                                <a class="dropdown-item" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document?type=advance-license-shipment") ?>">Advance License Shipment</a>
                                                                                <a class="dropdown-item" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document?type=epcg-shipment") ?>">EPCG Shipment</a>
                                                                                <a class="dropdown-item" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document?type=return-to-origin-shipment") ?>">Return to Origin Shipment</a>
                                                                            </div>
                                                                        </div>
                                                                    <?php } else { ?>

                                                                        <a class="btn btn-sm btn-primary" href="<?= base_url("fs-dms/create/$masterFormDetails->id/$documentType->document") ?>">Create</a>
                                                                    <?php } ?>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="tableServerside" class="mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php $counter = 0;
                                                foreach ($documetTypeList['post-shipment'] as $key => $documentType) { ?>
                                                    <?php $documentPermission = checkDocumentPermission($documentType->document, $masterFormDetails->transaction, $masterFormDetails->mode, $masterFormDetails->shipment, 'EXIM');
                                                    if ($documentPermission) { ?>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <td>
                                                                <?php if (in_array($documentType->status,['0','1']) && $documentPermission == 'edit') { ?>
                                                                    ...
                                                                    <a class="btn btn-sm btn-warning" href="<?= base_url("fs-dms/download/$masterFormDetails->id/$documentType->document") ?>">Download</a>
                                                                <?php } else if ($documentPermission == 'edit') { ?>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="tableServerside" class="mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $counter = 0;
                                                foreach ($documetTypeList['shipment_instructions'] as $key => $documentType) { ?>
                                                    <?php $documentPermission = checkDocumentPermission($documentType->document, $masterFormDetails->transaction, $masterFormDetails->mode, $masterFormDetails->shipment, 'EXIM');
                                                    if ($documentPermission) { ?>
                                                        <tr>
                                                            <td>
