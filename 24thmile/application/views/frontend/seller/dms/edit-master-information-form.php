                ...
                <div class="tracking-block">
                    <div class="tab-content">
                        ...
                        <form id="documentForm" action="" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="request_id" value="<?= $masterFormDetails->request_id ?>">
                                ...
                                <tbody>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 px-0">
                                                        <div class="radio">
                                                            ...
                                                            <label class="mr-3 ml-3"><input type="radio" aria-describedby="transaction-error" name="transaction" id="transaction_export" value="Export" disabled <?= $masterFormDetails->transaction == 'Export' ? ' checked ' : ''; ?>> Export</label>&nbsp;
                                                            <label class="mr-3 ml-3"><input type="radio" aria-describedby="transaction-error" name="transaction" id="transaction_import" value="Import" disabled <?= $masterFormDetails->transaction == 'Import' ? ' checked ' : ''; ?>> Import</label>&nbsp;
                                                    ...
                                                    <div class="col-lg-3 px-0">
                                                        <div class="radio">
                                                            ...
                                                            <?php foreach ($modes as $mode) { ?>
                                                                <label class="mr-3 ml-3"><input type="radio" name="mode" aria-describedby="mode-error" class="mode" value="<?php echo $mode['id']; ?>" <?= $masterFormDetails->mode_id == $mode['id'] ? 'checked' : ''; ?> disabled> <?php echo $mode['type']; ?></label>&nbsp;
                                                            <?php } ?>
                                                    ...
                                                    <div class="col-lg-3 px-0">
                                                        <div class="radio">
                                                            ...
                                                            <?php foreach ($shipments as $shipment) { ?>
                                                                <label class="mr-3 ml-3"><input type="radio" name="shipment" aria-describedby="shipment-error" class="shipment" value="<?php echo $shipment['id']; ?>" disabled <?= ($shipment['id'] == '1' && in_array($masterFormDetails->mode_id, ['1', '2'])) ? 'disabled="true"' : '' ?> <?= $masterFormDetails->shipment_id == $shipment['id'] ? 'checked' : ''; ?>> <?php echo $shipment['type']; ?></label>&nbsp;
                                                            <?php } ?>
                                                    ...
                                                    <div class="col-lg-3 px-0">
                                                        <div class="radio">
                                                            ...
                                                            <label class="mr-3 ml-3"><input type="radio" name="shipment_under_payment" disabled value="LUT BOND" <?= strcasecmp($masterFormDetails->shipment_under_payment, "LUT BOND") == 0 ? 'checked' : ''; ?>> LUT BOND</label>&nbsp;
                                                            <label class="mr-3 ml-3"><input type="radio" name="shipment_under_payment" disabled value="IGST" <?= strcasecmp($masterFormDetails->shipment_under_payment, "IGST") == 0 ? 'checked' : ''; ?>> IGST</label>&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="other_details[invoice_date]" id="invoice_date" class="date-picker form-control " placeholder="DD-MMM-YYYY" value="<?= printFormatedDate($other_details->invoice_date) ?>">

                                        </td>
                                        <td>
                                            <div>
                                                <label class="sr-no"> Buyer Reference / Purchase Order Number :</label>
                                                <div class=""><input type="text" class="form-control requiredClass" name="other_details[po_number]" id="#po_number" value="<?= htmlspecialchars($other_details->po_number) ?>"></div>
                                            </div>

                                        </td>
                                        <td>
                                            <div><label class="sr-no" style="min-width: 100px;">Date (if any):</label>
                                                <div class=""><input type="text" class="form-control date-picker" name="other_details[po_date]" id="#po_date" class="date-picker" value="<?= printFormatedDate($other_details->po_date) ?>"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" class="form-control requiredClass" name="other_details[country_of_origin]" value="<?= htmlspecialchars($other_details->country_of_origin) ?>">
                                        </td>

                                        <td>
                                            <label class="sr-no"> Country of Final Destination :</label>
                                            <input type="text" class="form-control requiredClass" name="other_details[country_of_final_destination]" value="<?= htmlspecialchars($other_details->country_of_final_destination) ?>">
                                        </td>

                                        <td>
                                            <label class="sr-no"> Port of Loading :</label>
                                            <input type="text" class="form-control requiredClass" name="other_details[port_of_l]" value="<?= htmlspecialchars($other_details->port_of_l) ?>">
                                        </td>

                                        <td>
                                            <label class="sr-no"> Port of Discharge :</label>
                                            <input type="text" class="form-control requiredClass" name="other_details[port_of_d]" value="<?= htmlspecialchars($other_details->port_of_d) ?>">
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" class="form-control requiredClass" name="other_details[place_of_receipt]" value="<?= htmlspecialchars($other_details->place_of_receipt) ?>">
                                        </td>

                                        <td>
                                            <label class="sr-no"> Final Destination :</label>

                                            <input type="text" class="form-control requiredClass" name="other_details[final_destination]" value="<?= htmlspecialchars($other_details->final_destination) ?>">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img id="userPhotoPreview" src="<?= $masterFormDetails->signature ?>" style="height:50px;width: 150px; object-fit: contain;" />
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control" name="other_details[designation]" value="<?= htmlspecialchars($other_details->designation) ?>">
                                        </td>
                                    </tr>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" class="form-control" name="other_details[commercial_invoice_number]" value="<?= htmlspecialchars($other_details->commercial_invoice_number) ?>">
                                        </td>
                                        <td>
                                            <label class="sr-no" style="min-width: 100px;">Date : </label>
                                            <input type="text" name="other_details[commercial_invoice_date]" id="commercial_invoice_date" class="date-picker form-control" value="<?= printFormatedDate($other_details->commercial_invoice_date) ?>">
                                        </td>
                                        <td>
                                            <label class="sr-no"> Shipping Bill Number : </label>
                                            <input type="text" class="form-control" name="other_details[shipping_bill_no]" id="#shipping_bill_no" value="<?= htmlspecialchars($other_details->shipping_bill_no) ?>">
                                        </td>
                                        <td>
                                            <label class="sr-no" style="min-width: 100px;">Date : </label>
                                            <input type="text" name="other_details[shipping_bill_date]" id="shipping_bill_date" class="date-picker form-control " value="<?= printFormatedDate($other_details->shipping_bill_date) ?>">
                                        </td>

                                    </tr>

                                    <tr>
                                        <td class="airwaybill" style="<?= $masterFormDetails->mode_id != 2 ? 'display:none' : '' ?>">
                                            <label class="sr-no">Air Way Bill Number :</label>
                                            <input type="text" class="form-control" name="other_details[airway_bill_number]" value="<?= htmlspecialchars($other_details->airway_bill_number) ?>">
                                        </td>
                                        <td class="airwaybill" style="<?= $masterFormDetails->mode_id != 2 ? 'display:none' : '' ?>">
                                            <label class="sr-no" style="min-width: 100px;">Date : </label>
                                            <input type="text" name="other_details[airway_bill_date]" id="airway_bill_date" class="date-picker form-control " value="<?= printFormatedDate($other_details->airway_bill_date) ?>">
                                        </td>
                                        <td class="billoflading" style="<?= $masterFormDetails->mode_id != 3 ? 'display:none' : '' ?>">
                                            <label class="sr-no"> Bill of Lading Number : </label>
                                            <input type="text" class="form-control " name="other_details[bill_of_lading]" id="#bill_of_lading" value="<?= htmlspecialchars($other_details->bill_of_lading) ?>">
                                        </td>
                                        <td class="billoflading" style="<?= $masterFormDetails->mode_id != 3 ? 'display:none' : '' ?>">
                                            <label class="sr-no" style="min-width: 100px;">Date : </label>
                                            <input type="text" name="other_details[bill_of_lading_date]" id="bill_of_lading_date" class="date-picker form-control " value="<?= printFormatedDate($other_details->bill_of_lading_date) ?>">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" class="form-control" name="other_details[vessel_aircraft_voyage_no]" value="<?= htmlspecialchars($other_details->vessel_aircraft_voyage_no) ?>">
                                        </td>
                                    </tr>
