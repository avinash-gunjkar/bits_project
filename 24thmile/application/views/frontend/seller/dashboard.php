           ...
           <div class="col-lg-4 col-md-3 col-sm-12 ">
             ...
             <div class="info-box">
               ...
               <div class="info-box-content">
                 ...
                 <span><a class="text-info" href="<?= base_url('fs-request-list?shipment=2') ?>">Inquiry(<?= $numberOfAwardedRequests->lcl_inquiry_count ?>)</a> | <a class="text-info" href="<?= base_url('fs-booking-list?shipment=2') ?>">Booking(<?= $numberOfAwardedRequests->lcl_booking_count ?>)</a></span>
               </div>
               <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
           ...
           <div class="col-lg-4 col-md-3 col-sm-12">
             ...
             <div class="info-box">
               ...
               <div class="info-box-content">
                 ...
                 <span><a class="text-info" href="<?= base_url('fs-request-list?shipment=1') ?>">Inquiry(<?= $numberOfAwardedRequests->fcl_inquiry_count ?>)</a> | <a class="text-info" href="<?= base_url('fs-booking-list?shipment=1') ?>">Booking(<?= $numberOfAwardedRequests->fcl_booking_count ?>)</a></span>
               </div>
               <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
           ...
           <div class="col-lg-4 col-md-3 col-sm-12">
             ...
             <div class="info-box">
               ...
               <div class="info-box-content">
                 ...
                 <span><a class="text-info" href="<?= base_url('fs-request-list?mode=2') ?>">Inquiry(<?= $numberOfAwardedRequests->air_inquiry_count ?>)</a> | <a class="text-info" href="<?= base_url('fs-booking-list?mode=2') ?>">Booking(<?= $numberOfAwardedRequests->air_booking_count ?>)</a></span>
               </div>
               <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
           ...
           <div class="col-lg-4 col-md-3 col-sm-12">
             ...
             <div class="info-box">
               ...
               <div class="info-box-content">
                 ...
                 <span><a class="text-info" href="<?= base_url('fs-request-list?mode=3') ?>">Inquiry(<?= $numberOfAwardedRequests->sea_inquiry_count ?>)</a> | <a class="text-info" href="<?= base_url('fs-booking-list?mode=3') ?>">Booking(<?= $numberOfAwardedRequests->sea_booking_count ?>)</a></span>
               </div>
               <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
           ...
           <div class="col-lg-4 col-md-3 col-sm-12">
             <div class="info-box">
               ...
               <div class="info-box-content">
                 ...
                 <span><a class="text-info" href="<?= base_url('fs-request-list?mode=1') ?>">Inquiry(<?= $numberOfAwardedRequests->road_inquiry_count ?>)</a> | <a class="text-info" href="<?= base_url('fs-booking-list?mode=1') ?>">Booking(<?= $numberOfAwardedRequests->road_booking_count ?>)</a></span>
               </div>
               <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
 ...
 <script>
   $('#finyear').change(function() {
     ...
     window.location = base_url + 'fs-dashboard?finyear=' + finyear + '#bookingShipmentStatus';
   });
 </script>