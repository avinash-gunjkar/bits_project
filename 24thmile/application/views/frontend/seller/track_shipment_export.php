                ...
                <div class="tracking-block">
                    <div class="tab-content">
                        ...
                        <div class="shipping-form-block">
                            <form class="steps" name="trackingFrm" id="trackingFrm" action="<?php echo base_url('seller/upload_export_process_documents'); ?>" enctype="multipart/form-data" method="post">
...
<script type="text/javascript">
    $('#trackingFrm').validate({
        rules: {
            ...
            'step1_export_other_documents_1': {
                extension: 'jpg|jpeg|png|pdf|docx|xlsx'
            },
            'step1_export_other_documents_2': {
                extension: 'jpg|jpeg|png|pdf|docx|xlsx'
            },
            'step1_export_other_documents_3': {
                extension: 'jpg|jpeg|png|pdf|docx|xlsx'
            },
            'post_shipment_doc1': {
                extension: 'jpg|jpeg|png|pdf|docx|xlsx'
    ...
    $('.editbtn').click(function(e){
        ...
        // $fieldset.find('.editableDataDiv').show(500);
        // $fieldset.find('.readonlyDataDiv').hide(500);
    ...
    $('input[name="shipment_under_payment"]').change(function(){
        var shipment_under_payment = $('input[name="shipment_under_payment"]:checked').val();
        console.log(shipment_under_payment);
        if(shipment_under_payment=='IGST'){
            $('#divIGSTAmount').show();
        }else{
            $('#divIGSTAmount').hide();
        }
