                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane <?php echo ($activeTab == 'profile') ? 'active' : ''; ?>" id="profile">		
                            <div class="put-reference-number">
                                <form name="profileForm" id="profileForm" action="<?php echo base_url('fs-company-profile'); ?>" method="post" enctype="multipart/form-data">
                                    <h3>Exporter-Importer - Details</h3>
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-row mb-3">
                                                <div class="col">
                                                    ...
                                                    <select class="custom-select chosen-select" name="industry_types[]" id="industry_types" multiple="">
                                                        <?php foreach ($industries as $industry) { ?>
                                                            <option <?php echo (in_array($industry['id'], $companyProfile->industryTypes) ) ? 'selected' : ''; ?> value="<?php echo $industry['id']; ?>"><?php echo $industry['title']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="col">
                                                    <label>Average annual import</label>
                                                    <select name="average_annual_import" class="custom-select">
                                                        <option value="Nil" <?= $companyProfile->average_annual_import == 'Nil' ? ' selected ' : '' ?>>Nil</option>
                                                        <option value="Upto 10 Lakhs" <?= $companyProfile->average_annual_import == 'Upto 10 Lakhs' ? ' selected ' : '' ?>>Upto 10 Lakhs</option>
                                                        <option value="10 Lakhs to 10 Crore" <?= $companyProfile->average_annual_import == '10 Lakhs to 10 Crore' ? ' selected ' : '' ?>>10 Lakhs to 10 Crore</option>
                                                        <option value="10 Crore to 100 Crore" <?= $companyProfile->average_annual_import == '10 Crore to 100 Crore' ? ' selected ' : '' ?>>10 Crore to 100 Crore</option>
                                                        <option value="Above 100 Crore" <?= $companyProfile->average_annual_import == 'Above 100 Crore' ? ' selected ' : '' ?>>Above 100 Crore</option>
                                                    </select>
                                                </div>
                                                <div class="col">
                                                    <label>Average annual export</label>
                                                    <select name="average_annual_export" class="custom-select">
                                                        <option value="Nil" <?= $companyProfile->average_annual_export == 'Nil' ? ' selected ' : '' ?>>Nil</option>
                                                        <option value="Upto 10 Lakhs" <?= $companyProfile->average_annual_export == 'Upto 10 Lakhs' ? ' selected ' : '' ?>>Upto 10 Lakhs</option>
                                                        <option value="10 Lakhs to 10 Crore" <?= $companyProfile->average_annual_export == '10 Lakhs to 10 Crore' ? ' selected ' : '' ?>>10 Lakhs to 10 Crore</option>
                                                        <option value="10 Crore to 100 Crore" <?= $companyProfile->average_annual_export == '10 Crore to 100 Crore' ? ' selected ' : '' ?>>10 Crore to 100 Crore</option>
                                                        <option value="Above 100 Crore" <?= $companyProfile->average_annual_export == 'Above 100 Crore' ? ' selected ' : '' ?>>Above 100 Crore</option>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <h3>Exporter-Importer - Contacts</h3>
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="col-6 pr-3">
                                                    <label>Head Mobile/Phone Number  <sup>*</sup></label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <select class="input-group-text custom-select" name="head_country_code" id="head_country_code">
                        ...
                        <div role="tabpanel" class="tab-pane <?php echo ($activeTab == 'kyc') ? 'active' : ''; ?>" id="kyc">
                            <div class="put-track-number">
                                ...
                                <form id="uploadKYC" action="<?php echo base_url('fs-kyc-documents'); ?>" method="post" enctype="multipart/form-data">
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <?php foreach ($companyProfile->kyc_documents as $key => $document) { ?>

                                            <div class="row" >

                                            <?php if($document['type']=='6'){?>
                                                <div class="col-2">
                                                ...
                                                <div class="col-1">
                                                    <label for="">LUT Valid date</label>
                                                    <input type="text" name="document_valid_date[<?= $key ?>]" value="<?=printFormatedDate($document['details']->doc_valid_date)?>" class="date-picker form-control">
                                                </div>
                                                <?php }else{ ?>
                                                    <div class="col-3">
                                                    <label><?= $document['documnetName'] ?> <?= $document['is_mandatory'] ? '*' : '' ?></label>
                                            ...
                                            <?php }?>
                                                ...
                                                <div class="col-4">
                                                    <label>File</label>
                                                    <input type="file" class="form-control preview <?= $document['is_mandatory'] ? '' : '' ?> validImage" data-previewTarget="#kycPreview<?= $key ?>" name="kyc_documents[<?= $key ?>]" id="kyc_documents<?= $document['type'] ?>"/>
                                                ...
                                                <div class="col-3 text-center">
                                                    <label class="btn-block">Uploaded Doc.</label>
                                                ...
                                                <div class="col-2 text-center  ">
                                                    <label>Status</label>
                                                    <?= $document['details']->status == '1' ? '<span class="text-success btn-block">Approved</span>' : '<span class=" btn-block text-danger">Approval Pending</span>' ?>
