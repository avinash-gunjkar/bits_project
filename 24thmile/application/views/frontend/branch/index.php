              ...
              <div class="tracking-block">
                  <div class="tab-content">
                    <div class="text-right tabhade">
                     <h2><?=$pageheading?></h2>
              		<a class="btn btn-info btn-sm mb-3" href="<?= base_url('add-branch/'.$type)?>">Add new</a>
                  	</div>
                          ...
                          <tbody>
                              <?php foreach ($branch_list as $key=>$branch) { ?>
                                <tr>
                                  ...
                                  <td>
                                      <a href="<?= base_url("edit-branch/$type/$branch->id")?>"   title="Edit"  class="fa fa-pencil fa-lg text-info" ></a>
                                      <a href="<?= base_url("delete-branch/$type/$branch->id")?>"  title="Delete" class="fa fa-trash fa-lg text-danger deleteConfirm" ></a>
                                  </td>
                                </tr>
                              <?php }?>
