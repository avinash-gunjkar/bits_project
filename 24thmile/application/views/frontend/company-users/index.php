   ...
   <div class="wshipping-content-block">
       ...
       <div class="row">
          <div class="col-12 col-lg-12">
              ...
              <a class="btn btn-info btn-sm mb-3" href="<?= base_url('add-company-user')?>">Add new</a>
              </div>
                          ...
                          <tbody>
                              <?php foreach ($user_list as $key=>$user) { ?>
                                <tr>
                                  ...
                                  <td><?=$user->supervisor_name?$user->supervisor_name:'- -'?></td>
                                  <td>
                                      <a href="<?= base_url('edit-company-user/'.$user->id)?>" title="Edit" class="fa fa-pencil fa-lg text-info " ></a>
                                      &nbsp;
                                      <a href="<?= base_url('delete-company-user/'.$user->id)?>" title="Delete" class="fa fa-trash fa-lg text-danger deleteConfirm" ></a>
                                  </td>
                                </tr>
                              <?php }?>
