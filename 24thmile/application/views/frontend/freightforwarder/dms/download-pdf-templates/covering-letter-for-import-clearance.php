                ...
                <div class="col-12 col-lg-12">
                    <div class="tracking-block">
                        <div class="tab-content">
                            ...
                            <div>Date: <?= printFormatedDate($other_details->document_date) ?>
                            </div>
                            <div>Kind Attention: <?= $other_details->person_name ?></div>
                            <div><?= $other_details->company_name ?></div>
                            <div><?= $other_details->address_line1 ?></div>
                            <div><?= $other_details->address_line2 ?></div><br><br>
                            <div><center>
                            <strong><u>Subject:</u></strong> <?=$other_details->subject?>
                            </center></div><br>
                            ...
                            <div>For, <?= $other_details->exporters_company_name ?></div>
                            <br><br>
