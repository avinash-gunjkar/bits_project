...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.4.2/chosen.css" />
   ...
   <div class="wshipping-content-block">
       ...
       <div class="row">
        ...
        <form name="profileForm" id="profileForm" action="<?php echo base_url('ff-my-profile'); ?>" method="post" enctype="multipart/form-data">
<!--             <h3>User Details</h3>-->
             <div class="row">
                ...
                <div class="form-row mb-3">
                 ...
                 <div class="col-6" >
                     <div class="form-row mb-3">
                        ...
                        <input type="file" class="custom-file-input preview" data-previewTarget="#userPhotoPreview" name="profile_pic" id="profile_pic">
            ...
            <div role="tabpanel" class="tab-pane <?php echo ($activeTab == 'setting') ? 'active' : '' ; ?>" id="setting">
                  ...
                  <div class="">
                  <form action="<?php echo base_url('freightforwarder/change_password'); ?>" method="post" id="changePasswordForm">
