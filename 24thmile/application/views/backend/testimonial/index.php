  ...
  <div class="container">
    <div class="section">
      <div class="right pt-10" style="padding: 10px">
        <a href="<?= base_url('admin/testimonial/add') ?>" class="btn waves-effect waves-light " type="submit" name="action">Add Testimonial<i class="mdi-content-add right"></i></a>
      </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#serversideDatatable').DataTable({
      serverSide: true,
      ajax: {
        url: '<?= base_url('admin/ajaxTestimonial') ?>',
        type: 'POST'
      },
      "columns": [{
          "data": "id",
        ...
        },
        {
          ...
          "render": function(data, type, row, meta) {
            return '<a href="' + base_url + 'admin/testimonial/edit/' + data + '">Edit</a>';
          }
        }
      ]
  ...
  $(document).on('click','.toggleActive',function(event) {
    ...
    var BasePath = "<?php echo base_url('admin/testimonial/changeStatus'); ?>"
