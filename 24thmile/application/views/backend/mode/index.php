          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Mode</h5>
        ...
        <div class="container">
          <div class="section">
            <div class="right pt-10" style="padding: 10px">
                <a href="<?php echo base_url('mode/add')?>" class="btn waves-effect waves-light " type="submit" name="action">Add Mode<i class="mdi-content-add right"></i></a>              
            </div>  
                  ...
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $mode['type'] ?></td> 
                            <td>
                                <div class="switch">
                                  <label>
                                    Inactive
                                    <input class="toggleActive" type="checkbox" id="mode-<?php echo $mode['id']; ?>" <?php echo $mode['isActive'] ==1 ? 'checked' : '' ?>>
                            ...
                            <td>
                                <a href="<?php echo base_url('mode/edit') ?>/<?php echo $mode['id'] ?>" class="btn-floating waves-effect waves-light light-blue lighten-2"><i class="mdi-editor-mode-edit"></i></a>
...
<script type="text/javascript">
    ...
    $('.toggleActive').click(function(event) { 
      ...
      var BasePath = "<?php echo base_url('mode/changeStatus');?>"
