        ...
        <div class="container">
          <div class="section">
            <div class="right pt-10" style="padding: 10px">
                <a href="<?php echo base_url('sector/add')?>" class="btn waves-effect waves-light " type="submit" name="action">Add Sector<i class="mdi-content-add right"></i></a>              
            </div>  
                  ...
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo substr($sector['description'],0,50).'...'  ?></td>  
                            <td>
                                <div class="switch">
                                  <label>
                                    Inactive
                                    <input class="toggleActive" type="checkbox" id="company-<?php echo $sector['id']; ?>" <?php echo $sector['isActive'] ==1 ? 'checked' : '' ?>>
                            ...
                            <td>
                                <a href="<?php echo base_url('sector/edit') ?>/<?php echo $sector['id'] ?>" class="btn-floating waves-effect waves-light light-blue lighten-2"><i class="mdi-editor-mode-edit"></i></a>
