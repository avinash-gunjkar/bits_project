                ...
                <tr>
                  ...
                  <td>
                    <div class="input-field">
                      ...
                      <input type="text" class="datepicker-from" id="fromDate" name="fromDate" value="<?= $this->input->get('fromDate') ?>">
                  ...
                  <td>
                    <div class="input-field">
                      ...
                      <input type="text" class="datepicker-to" id="toDate" name="toDate" value="<?= $this->input->get('toDate') ?>">
...
<script>
  $(document).ready(function(){
     ...
     serverSide: true, 
      ajax: {
         url: '<?=base_url('admin/ajaxBookingList'.($company_id?"/$company_id":''))?>',
         type: 'POST',
         dataType: 'json',
         data:{'filter':{
    ...
    //  }, 
     ...
     { "data": "trackingSteps","orderable":false },
     { "data": "status_title","orderable":false,
       "render":function(data,type,row,meta){
          if(row.role=='3'){
            return "<span class='status "+slugify(row.quote_status_title)+"'>"+(row.quote_status=='5'?row.tracking_status_title:row.quote_status_title)+"</span>";
          }else{
            return "<span class='status "+slugify(row.status_title)+"'>"+(row.status=='5'?row.tracking_status_title:row.status_title)+"</span>";
