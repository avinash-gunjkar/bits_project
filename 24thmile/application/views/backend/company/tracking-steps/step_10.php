<?php if (!$skipComparative) { ?>
        <fieldset <?php echo ($currentStep->step_id == $stepData[$key]->id) ? 'style="opacity: 1; display: block;"' : '' ?>>
                ...
                <div class="shipping-form">
                        <h5>Service Invoice from Freight Forwarder <?php echo $status; ?></h5>
                                ...
                                <div class="col l12">
                                        ...
                                        <div class="form-group">
                                                <div class="form-check form-check-inline">
                                                        <input type="radio" name="step10_export_status" class="form-check-input" value="1">
                                                        <label for="approve" class="form-check-label">Approve</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                        <input type="radio" name="step10_export_status" class="form-check-input" value="3">
                ...
                if (!empty($shipmentProcessData[$key]->step_id)) {
                        if (isset($shipmentProcessData[$key]->step_id) && $stepData[$key]->id == $shipmentProcessData[$key]->step_id && $shipmentProcessData[$key]->status != 1) { ?>
                                <!-- <input type="hidden" name="step_id_10" value="<?php echo $stepData[$key]->id; ?>"> -->
                                <!-- <input type="submit" name="step10_export" class="btn btn-default-cust btn btn-submit pull-right" value="Submit" /> -->
                        <?php }
                } else { ?>
                        <!--            <input type="hidden" name="step_id_10" value="<?php echo $stepData[$key]->id; ?>">
            <input type="submit" name="step10_export" class="btn btn-default-cust btn btn-submit pull-right" value="Submit" />-->
