              ...
              <div class="row">
                <div class="col s12 m12 l8 offset-l2">
                  <div class="card-panel">
                    ...
                    <div class="row">
                      <form class="col s12" id="formData" action="<?php echo base_url('admin/news-and-events/add');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="input-field col s12">
                           ...
                           <input type="text" name="date" width="220" id="date" class="datepicker" value="<?=printFormatedDate($recordDetails->date)?>">
