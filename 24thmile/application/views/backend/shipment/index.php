          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Shipment</h5>
        ...
        <div class="container">
          <div class="section">
            <div class="right pt-10" style="padding: 10px">
                <a href="<?php echo base_url('shipment/add')?>" class="btn waves-effect waves-light " type="submit" name="action">Add Shipment<i class="mdi-content-add right"></i></a>              
            </div>  
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="switch">
                                  <label>
                                    Inactive
                                    <input class="toggleActive" type="checkbox" id="contract-<?php echo $shipment['id']; ?>" <?php echo $shipment['isActive'] ==1 ? 'checked' : '' ?>>
                            ...
                            <td>
                                <a href="<?php echo base_url('shipment/edit') ?>/<?php echo $shipment['id'] ?>" class="btn-floating waves-effect waves-light light-blue lighten-2"><i class="mdi-editor-mode-edit"></i></a>
