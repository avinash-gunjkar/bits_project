  ...
  .input-field label.active{
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add Freight Template</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Dashboard</a>
                  </li>
                  <li><a href="#">Master</a>
                  </li>
                  <li class="active">Freight Template</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
          <p class="caption">Add Freight Template</p>
              ...
              <div class="row">
                <div class="col s12 m12">
                  <div class="card-panel">
                    ...
                    <div class="row">
                      <form class="col s12" id="freight_add_form" action="<?php echo base_url('freight/add');?>" method="POST">
                       <div class="row">
                         ...
                         <div class="input-field col s12 m6 l6">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="doSubmit"  value="doSubmit" name="action">Add Freight Template<i class="mdi-content-send right"></i>
                              </button>
                            </div>
                        </div>
                      </form>
