          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Freight Seller</h5>
                <ol class="breadcrumbs">
                    <li><a href="<?php echo base_url('admin/dashboard')?>">Dashboard</a></li>
                    <!-- <li><a >Users</a></li> -->
                    <li class="active">Freight Seller</li>
                </ol>
              </div>
            </div>
          </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td>
                              ...
                              <a href=""   class="btn waves-effect waves-light ">View</a>
                              
                              <a href=""  class="btn waves-effect waves-light " title="RFC List">RFC List</a>
                              
                              <a href=""  class="btn waves-effect waves-light " title="Booking List">Booking List</a>
...
<script type="text/javascript">
    ...
    $('.toggleActive').click(function(event) { 
      ...
      var BasePath = "<?php echo base_url('admin/freight-seller/changeStatus');?>"
